...
def main():
    ...
    if len(user_input) > 0 and len(image_input) > 0:
        ...
        with col1:
            ...
            prompt_template = """You are a digital marketing and SEO expert and your task is to write articles so write an article on the given topic: {user_input}. The article must be under 800 words. The article should be lengthy.
            """
        ...
        with col3:
            st.subheader("Final Article to Donwload")
